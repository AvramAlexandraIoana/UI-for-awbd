...
class InfoShow extends Component {
    ...
    render() {
        ...
        return (   
            <Card style={{ width: '50%' }}>
                <Card.Img style={{ height: '500px' }} variant="top" src={`${SERVE_URL}${this.props.match.params.id}`} />
                <Card.Body>
                    <Card.Text>
                        { item.description }
                    </Card.Text>
                    <Button variant="primary"  href="/location/list">Go to Location list</Button>
                    <Button style={{float: 'right' }} variant="secondary"  href={'/info/' + this.props.match.params.id}>Edit location info</Button>
